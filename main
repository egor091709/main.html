<html>
    ...
    <body>
        ...
        <main>
            ...
            <img class="tr" src="https://ouch-cdn2.icons8.com/QWMDvYbuaE4pbiFX0w6MTM5QT6WJfOjHT3hEhd2Dxx4/rs:fit:256:282/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9zdmcvNzE5/LzI4ZTlhOGVhLTU0/MmQtNDdkZi05MmU0/LTQzMGVkODFmZDQw/Yi5zdmc.png" height="20px" width="20px"/>
            ...
            <section class="info">
                ...
                <article class="post">
                    <h2>Телефон мечты</h2>
                    <img class="pos" src="https://learn.algoritmika.org/uploads/2021/03/tag-151102.svg" width="100px" height="80px"/>
